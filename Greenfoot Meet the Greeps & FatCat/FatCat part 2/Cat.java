...
public class Cat extends Actor
{
    ...
    {
        for (final int i : lang.stride.Utility.makeRange(1, distance)) {
            setImage(img1);
            wait(4);
    ...
    public void dance()
    {
        ...
        for (final int i : lang.stride.Utility.makeRange(0, 1)) {
        ...
        for (final int i : lang.stride.Utility.makeRange(0, 4)) {
            setImage("cat-dance.png");
            wait(8);
            setImage("cat-dance-2.png");
            wait(6);
    ...
    {
        for (final int i : lang.stride.Utility.makeRange(1, howLong)) {
            for (final int j : lang.stride.Utility.makeRange(1, 4)) {
    ...
    public void eat()
    {
        for (final int i : lang.stride.Utility.makeRange(0, 3)) {
